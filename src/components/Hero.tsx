...
export function Hero({}: Props): ReactElement {
  ...
  return (
    <div className="h-[65rem] flex flex-col space-y-8 items-center justify-center text-center overflow-hidden z-0">
      <BackgroundCircles />
      <Image
        className="relative rounded-full h-32 w-32 mx-auto object-cover"
        alt="Personal Photo"
        src="https://avatars.githubusercontent.com/u/33070329?v=4"
        width={256}
        height={256}
      />
      <div className="z-20">
